        ...
        <Stack gap={2}>
          ...
          <Card>
            <CardContent>
              ...
              <Typography>
                - Gemessen wird die Gesamtzeit, beginnend mit dem Start des
                ersten Starters und Ende der zweiten Laufrunde des dritten
                Starters.
              </Typography>
              <Typography>
                - Jeder Fehlschuss mit dem Lichtgewehr wird mit einem
                Zeitzuschlag (an Stelle von Strafrunden) von 15 Sekunden
                „belohnt“.
              </Typography>
              <Typography>
              ...
              <Typography>
                - Jeder mit dem Bogen geschossene Pfeil im Gold (gelber Ring)
                wird mit Zeitabzug von 15 Sekunden belohnt;
              </Typography>
              <Typography>
                - Die Mannschaft mit der niedrigsten Gesamtzeit ist der Sieger
