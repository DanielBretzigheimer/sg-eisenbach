...
export function DataProtection() {
  return (
    <>
      ...
      <Typography variant="h5">Verantwortlicher</Typography>
      <ul>
        ...
        <li>
          E-Mailadresse:{" "}
          <Link href="mailto:dbretzigheimer95@gmail.com">
      ...
      <Typography variant="h5">Zweck der Verarbeitung</Typography>
      <ul>
        <li>
      ...
      <Typography variant="h5">Verwendete Begrifflichkeiten</Typography>
      <p>
      ...
      <Typography variant="h5">Maßgebliche Rechtsgrundlagen</Typography>
      <p>
      ...
      <Typography variant="h5">Sicherheitsmaßnahmen</Typography>
      <p>
      ...
      <Typography variant="h5">Übermittlungen in Drittländer</Typography>
      <p>
      ...
      <Typography variant="h5">Rechte der betroffenen Personen</Typography>
      <p>
      ...
      <Typography variant="h5">Widerrufsrecht</Typography>
      <p>
      ...
      <p>
        ...
        Seite{" "}
        <Link href="http://www.aboutads.info/choices/oder">
      ...
      <Typography variant="h5">Löschung von Daten</Typography>
      <p>
      ...
      <Typography variant="h5">Newsletter - ActiveCampaign</Typography>
      <p>
        ...
        hier einsehen:{" "}
        <Link href="https://www.activecampaign.com/privacy-policy/">
        ...
        einzuhalten (
        <Link href="https://www.privacyshield.gov/participant?id=a2zt0000000GnH6AAK&status=Active">
      ...
      <Typography variant="h5">Hosting und E-Mail-Versand</Typography>
      <p>
      ...
      <Typography variant="h5">Google Tag Manager</Typography>
      <p>
        ...
        <Link href="https://www.google.com/intl/de/tagmanager/use-policy.html">
      ...
      <p>
        ...
        <Link href="https://www.privacyshield.gov/participant?id=a2zt000000001L5AAI&status=Active">
      ...
      <Typography variant="h5">Google Universal Analytics</Typography>
      <p>
        Wir setzen Google Analytics in der Ausgestaltung als
        „Universal-Analytics“ ein. „
        <Link href="https://support.google.com/analytics/answer/2790010?hl=de&ref_topic=6010376">
          Universal Analytics
        </Link>
        “ bezeichnet ein Verfahren von Google Analytics, bei dem die
        Nutzeranalyse auf Grundlage einer pseudonymen Nutzer-ID erfolgt und
      ...
      <Typography variant="h5">Google Doubleclick</Typography>
      <p>
        Wir nutzen auf Grundlage unserer berechtigten Interessen (d.h. Interesse
        an der Analyse, Optimierung und wirtschaftlichem Betrieb unseres
        Onlineangebotes im Sinne des Art. 6 Abs. 1 lit. f. DSGVO) die Dienste
      ...
      <Typography variant="h5">Onlinepräsenzen in sozialen Medien</Typography>
      <p>
      ...
      <ul>
        <li>
          ...
          , Privacy Shield:{" "}
          <Link href="https://www.privacyshield.gov/participant?id=a2zt0000000GnywAAC&status=Active">
        ...
        <li>
          ...
          <Link href="http://instagram.com/about/legal/privacy/">
        ...
        <li>
          ...
          , Opt-Out:{" "}
          <Link href="https://twitter.com/personalization">
            https://twitter.com/personalization
          </Link>
          , Privacy Shield:{" "}
          <Link href="https://www.privacyshield.gov/participant?id=a2zt0000000TORzAAO&status=Active">
        ...
        <li>
          ...
          <Link href="https://about.pinterest.com/de/privacy-policy">
        ...
        <li>
          ...
          , Opt-Out:{" "}
          <Link href="https://www.linkedin.com/psettings/guest-controls/retargeting-opt-out">
            https://www.linkedin.com/psettings/guest-controls/retargeting-opt-out
          </Link>
          , Privacy Shield:{" "}
          <Link href="https://www.privacyshield.gov/participant?id=a2zt0000000L0UZAA0&status=Active">
        ...
        <li>
          ...
          <Link href="https://wakelet.com/privacy.html">
        ...
        <li>
          ...
          <Link href="https://soundcloud.com/pages/privacy">
      ...
      <Typography variant="h5">Google ReCaptcha</Typography>
      <p>
      ...
      <Typography variant="h5">Google Maps</Typography>
      <p>
      ...
      <Typography variant="h5">Pinterest</Typography>
      <p>
        Innerhalb unseres Onlineangebotes können Funktionen und Inhalte des
