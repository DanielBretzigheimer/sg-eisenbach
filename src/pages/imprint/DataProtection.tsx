export function DataProtection() {
  return (
    <>
      ...
      <ul>
        <li>Daniel, Bretzigheimer</li>
        <li>Bergstraße 26</li>
        <li>63785 am Main Obernburg (Deutschland)</li>
        <li>
          E-Mailadresse:{" "}
          <a href="mailto:dbretzigheimer95@gmail.com">
            dbretzigheimer95@gmail.com
          </a>
        </li>
      </ul>
      ...
      <p>
        ...
        denen, zu denen sie ehoben wurden, bestimmt sich nach den Vorgaben des
      ...
      <p>
        ...
        Rahmen unserer Datenschutzerklärung auf. Falls die Nutzer nicht möchten,
        ...
        Funktionseinschränkungen dieses Onlineangebotes führen. Ein genereller
        Widerspruch gegen den Einsatz der zu Zwecken des Onlinemarketing
        eingesetzten Cookies kann bei einer Vielzahl der Dienste, vor allem im
      ...
      <p>
        ...
        oder Öffentlichkeitsarbeit handelt. Die hierbei verarbeiteten Daten, die
        Art, der Umfang und der Zweck und die Erforderlichkeit ihrer
        ...
        der Personen (z.B., Name, Adresse, etc.), als auch die Kontaktdaten
        (z.B., E-Mailadresse, Telefon, etc.), die Vertragsdaten (z.B., in
        Anspruch genommene Leistungen, mitgeteilte Inhalte und Informationen,
        Namen von Kontaktpersonen) und sofern wir zahlungspflichtige Leistungen
        oder Produkte anbieten, Zahlungsdaten (z.B., Bankverbindung,
        Zahlungshistorie, etc.). Wir löschen Daten, die zur Erbringung unserer
        ...
        Beziehungen. Im Fall geschäftlicher Verarbeitung bewahren wir die Daten
        so lange auf, wie sie zur Geschäftsabwicklung, als auch im Hinblick auf
        etwaige Gewährleistungs- oder Haftungspflichten relevant sein können.
        Die Erforderlichkeit der Aufbewahrung der Daten wird alle drei Jahre
        überprüft; im Übrigen gelten die gesetzlichen Aufbewahrungspflichten.
      </p>
      <h2>Newsletter - ActiveCampaign</h2>
      <p>
        ...
        hier einsehen: https://www.activecampaign.com/privacy-policy/.
        ActiveCampaign ist unter dem Privacy-Shield-Abkommen zertifiziert und
        bietet hierdurch eine Garantie, das europäisches Datenschutzniveau
        einzuhalten
        ...
        eingesetzt. Der Versanddienstleister kann die Daten der Empfänger in
      ...
      <h2>Google Adsense mit personalisierten Anzeigen</h2>
      <p>
        ...
        Nutzer pseudonymisiert. Wir setzen Adsense mit personalisierten Anzeigen
        ein. Dabei zieht Google auf Grundlage der von Nutzern besuchten Websites
        oder verwendeten Apps und den so erstellten Nutzerprofilen Rückschlüsse
        auf deren Interessen. Werbetreibende nutzen diese Informationen, um ihre
        ...
        Zielgruppenlisten, die in DoubleClick Bid Manager oder Campaign Manager
        hochgeladen wurden. Weitere Informationen zur Datennutzung durch Google,
      ...
      <h2>Google AdWords und Conversion-Messung</h2>
      <p>
        Wir nutzen auf Grundlage unserer berechtigten Interessen (d.h. Interesse
        an der Analyse, Optimierung und wirtschaftlichem Betrieb unseres
        Onlineangebotes im Sinne des Art. 6 Abs. 1 lit. f. DSGVO) die Dienste
        ...
        um Nutzern nur Anzeigen zu präsentieren, die potentiell deren Interessen
        ...
        unserer und anderer Webseiten, auf denen das Google-Werbe-Netzwerk aktiv
        ist, unmittelbar durch Google ein Code von Google ausgeführt und es
        werden sog. (Re)marketing-Tags (unsichtbare Grafiken oder Code, auch als
        "Web Beacons" bezeichnet) in die Webseite eingebunden. Mit deren Hilfe
        wird auf dem Gerät der Nutzer ein individuelles Cookie, d.h. eine kleine
        ...
        denen sich Nutzer persönlich identifizieren lassen. Die Daten der Nutzer
        werden im Rahmen des Google-Werbe-Netzwerks pseudonym verarbeitet. D.h.
        Google speichert und verarbeitet z.B. nicht den Namen oder E-Mailadresse
        der Nutzer, sondern verarbeitet die relevanten Daten cookie-bezogen
        ...
        davon wer dieser Cookie-Inhaber ist. Dies gilt nicht, wenn ein Nutzer
        Google ausdrücklich erlaubt hat, die Daten ohne diese Pseudonymisierung
        zu verarbeiten. Die über die Nutzer gesammelten Informationen werden an
      ...
      <p>
        ...
        und welche Angebote der Nutzer geklickt hat, ferner technische
        Informationen zum Browser und Betriebssystem, verweisende Webseiten,
        Besuchszeit sowie weitere Angaben zur Nutzung des Onlineangebotes. Es
        wird ebenfalls die IP-Adresse der Nutzer erfasst, wobei diese innerhalb
        ...
        Anzeigen angezeigt werden. Die Daten der Nutzer werden im Rahmen des
        Google-Werbe-Netzwerks pseudonym verarbeitet. D.h. Google speichert und
        verarbeitet z.B. nicht den Namen oder E-Mailadresse der Nutzer, sondern
        verarbeitet die relevanten Daten cookie-bezogen innerhalb pseudonymer
        Nutzerprofile. D.h. aus der Sicht von Google werden die Anzeigen nicht
        für eine konkret identifizierte Person verwaltet und angezeigt, sondern
        für den Cookie-Inhaber, unabhängig davon wer dieser Cookie-Inhaber ist.
        Dies gilt nicht, wenn ein Nutzer Google ausdrücklich erlaubt hat, die
        ...
        gespeichert. Weitere Informationen zur Datennutzung durch Google,
        Einstellungs- und Widerspruchsmöglichkeiten, erfahren Sie in der
        Datenschutzerklärung von Google
        (https://policies.google.com/technologies/ads) sowie in den
        Einstellungen für die Darstellung von Werbeeinblendungen durch Google
      ...
      <p>
        ...
        http://instagram.com/about/legal/privacy/. - Twitter (Twitter Inc., 1355
        ...
        https://about.pinterest.com/de/privacy-policy. - LinkedIn (LinkedIn
        ...
        Datenschutzerklärung/ Opt-Out:
        https://privacy.xing.com/de/datenschutzerklaerung. - Wakalet (Wakelet
        Limited, 76 Quay Street, Manchester, M3 4PR, United Kingdom) -
      ...
      <p>
        ...
        werden: https://developers.facebook.com/docs/plugins/. Facebook ist
        ...
        Facebook entnehmen: https://www.facebook.com/about/privacy/. Wenn ein
      ...
      <p>
        ...
        den dortigen Profilen der Nutzer zuordnen. Twitter ist unter dem
      ...
      <p>
        ...
        Parkway, Mountain View, CA 94043, USA („Google“), eingebunden werden.
        ...
        Funktionen den dortigen Profilen der Nutzer zuordnen. Google ist unter
