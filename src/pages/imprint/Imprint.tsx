  ...
  return (
    <>
      ...
      <p>
        ...
        (Im MS Internet-Explorer unter ''Extras - Internetoptionen - Datenschutz - Einstellung''; im
        Firefox unter ''Extras - Einstellungen - Datenschutz - Cookies''); wir weisen Sie jedoch
