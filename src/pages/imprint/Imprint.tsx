...
export function Imprint() {
  return (
    <>
      ...
      <Typography variant="h4">Haftungsausschluss:</Typography>
      ...
      <Typography variant="h5">Google AdSense</Typography>
      <p>
      ...
      <p>
        ...
        der
        <Link href="https://www.kanzlei-hasselbach.de/standorte/bonn/">
